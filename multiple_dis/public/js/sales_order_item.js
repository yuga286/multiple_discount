...
// APPLY TO ALL
// common_item_events("Sales Order Item");
// common_item_events("Delivery Note Item");
// common_item_events("Sales Invoice Item");
...
//             if (!r.message || !Array.isArray(r.message.uoms)) return;
