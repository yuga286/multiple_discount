...
# Purchase discount is now handled by
# multiple_dis.overrides.discount.apply_purchase_discount (before_validate hook).
# See multiple_dis/overrides/discount.py for the implementation.